...
public class LogicaLogin {
	...
	public static Usuarios comprobarContrasena(String nombre, String contraseñaIntroducida)
		...
		//solo llegamos aquñ si el login fue incorrecto
		logger.info("Login incorrecto");
		return usuario;	//null si no existe el usuario o fallñ la conexiñn con la BD
